...
Given  a book isbn is "1152198745"
When I search through a book by its isbn like "115"
Then One result should be printed
Scenario: Searching for a substring of the ISBN
Given  a book isbn is "1152198745"
When I search through a book by its isbn "745"
Then One result should be printed
Scenario: No books match the Searched isbn
Given a book isbn is "1152198745"
When I search through a book by its isbn the entered isbn "7335"
